<?php
	...
	if(isset($colores['colordestacado']))
		$colorDestacado = $colores['colordestacado'];
	else
		$colorDestacado = '#333'; //Color por defecto

?>
/* Aplicaciones del color destacado*/
#search_mini_form input#search {
    border: 1px solid <?php echo $colorDestacado ?> !important;
}

.header-top-container {
    border-bottom: 1px solid <?php echo $colorDestacado ?> !important;
}

#posicion-bar, #posicion-bar a{
	color: <?php echo $colorDestacado ?> !important;
}

/* End Aplicaciones del color destacado*/
