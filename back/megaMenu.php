              ...
              <div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <input type="radio" name="MM_colores" id="MM_colores" value='1' <?=$elemento[ 'MM_colores']==1 ? 'checked': ''?>> Black/Green
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-1"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='2' <?=$elemento[ 'MM_colores']==2 ? 'checked': ''?>> Black/Blue
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-2"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='3' <?=$elemento[ 'MM_colores']==3 ? 'checked': ''?>> Black/Violet
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-3"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='4' <?=$elemento[ 'MM_colores']==4 ? 'checked': ''?>> Black/Orange
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-4"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='5' <?=$elemento[ 'MM_colores']==5 ? 'checked': ''?>> Black/Pistachio
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-5"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='6' <?=$elemento[ 'MM_colores']==6 ? 'checked': ''?>> Black/Pink
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-6"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='7' <?=$elemento[ 'MM_colores']==7 ? 'checked': ''?>> Black/Yellow
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-7"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='8' <?=$elemento[ 'MM_colores']==8 ? 'checked': ''?>> Black/Gray
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-8"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='9' <?=$elemento[ 'MM_colores']==9 ? 'checked': ''?>> Black
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-9"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='10' <?=$elemento['MM_colores']==10 ? 'checked': ''?>> Blue
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-10"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='11' <?=$elemento[ 'MM_colores']==11 ? 'checked': ''?>> Gray/Red
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-11"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='12' <?=$elemento[ 'MM_colores']==12 ? 'checked': ''?>> Light Purple
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-12"></div>
                    <br>
                    <input type="radio" name="MM_colores" id="MM_colores" value='13' <?=$elemento[ 'MM_colores']==13 ? 'checked': ''?>> White
                    <div class="ruby-menu-demo-circle ruby-menu-demo-color-13"></div>
                    <br>
                  </div>
                </div>
