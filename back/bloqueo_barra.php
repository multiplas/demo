        ...
        <?php } ?>
            ...
            <div id="edi" class="block">
                <div class="navbar navbar-inner block-header">
                    <div class="muted pull-left">Activar Bloqueo Barra de Navegacion</div>
                </div>
                <div class="block-content collapse in">
                    <div class="span12">
                        <form action="bloqueo_barra.php?bloqueobarra=true" method="post" class="form-horizontal">
                            <fieldset>
                                <div>
                                    <legend>Bloqueo Barra de navegación</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="actanu">Activo</label>
                                            <div class="controls">
                                                <select id="b_bar" name="b_bar"  class="span6">
