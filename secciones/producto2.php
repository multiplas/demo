		...
		?>
				<!--<div class="producto">
					...
					<div class="info">
						<div class="info2">
							...
							<span class="precioAnterior"><?=($producto['descuento'] > 0) ? $producto['precio_ant'].$_SESSION['moneda'] : '';?></span>
							<span class="precio"><?=$producto['precio']?> <?=$_SESSION['moneda']?></span>
						</div>
                ...
                ?>
                    ...
                    <div class="fotorama" data-transition="dissolve" data-loop="true" data-autoplay="true" data-arrows="false" data-click="false" data-fit="cover" data-nav="thumbs" data-swipe="false">
						...
						<div class="talla" style="text-align:center;">
							...
							<select id="cantidadmuliselect" style="<?=$producto['precio'] != 'Consultar' ? '' : ' display: none;'?>">
								<?php
									for($i = 1; $i <= 10; $i++)
						...
						<!--<span class="descuento">&nbsp;<?=($producto['descuento'] > 0 && $producto['precio'] != 'Consultar') ? '-'.$producto['descuento'].' '.$producto['descuentoe'] : '';?>&nbsp;</span>
                            ...
                            <span class="precioAnterior">&nbsp;<?=($producto['descuento'] > 0 && $producto['precio'] != 'Consultar') ? $producto['precio_ant'].$_SESSION['moneda'] : '';?>&nbsp;</span>-->
                            <span itemprop="price" id="preciopr" class="precio">Precio: <?=$producto['precio']?><?=$producto['precio'] != 'Consultar' ? number_format(ConvertirMoneda($Empresa['moneda'],$_SESSION['divisa'],$_SESSION['moneda']), 2, ',', '.') : ''?></span>
                        </div>
                        <?php
                            ...
                            {
                                ?><a class="button" name="BtSubmit" href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>contacto/<?=str_replace(' ', '-', $producto['nombre'])?>">Consultar Precio</a><?php
                            }
                        ?>
                    ...
                    <div itemprop="description" class="descripcion"><br>
                        <!-- Buttons start here. Copy this ul to your document. -->
                                ...
                                <?php include('./bloques/social_sharing.php'); ?>
                            <!-- Buttons end here -->
                        <h2>DESCRIPCIÓN</h2>
						<?=$producto['descripcion']?>
					</div>
				...
				<div class="producto-r">
					...
					<div class="info">
						<span class="descuento">&nbsp;<?=($producto['descuento'] > 0 && $producto['precio'] != 'Consultar') ? '-'.$producto['descuento'].' '.$producto['descuentoe'] : '';?>&nbsp;</span>
                            ...
                            <span itemprop="price" id="preciopr" class="precio"><?=number_format(ConvertirMoneda($Empresa['moneda'],$_SESSION['divisa'],$producto['precio']), 2, ',', '.')?><?=$producto['precio'] != 'Consultar' ? $_SESSION['moneda'] : ''?></span>
                        </div>
                    <?php } ?>
					<div class="foto">
					...
					<form action="<?=$draizp?>/acc/anadir/<?=$producto['id']?>" method="post">
						...
						<div class="talla">
							<select id="cantidadmuliselect" style="width: auto !important;<?=$producto['precio'] != 'Consultar' ? '' : ' display: none;'?>">
								<?php
									for($i = 1; $i <= 10; $i++)
										echo '<option value="'.$i.'">'.$i.'</option>';
								?>
            ...
            ?>
					...
					<div class="foto">
                        ...
                        <form action="<?=$draizp?>/acc/anadir/<?=$producto['id']?>" method="post" style="max-height: 550px !important; margin-left: 0px; width: 100%">
                        <style>
                        #modal {
                            width:100%; /*Toma el 100% del ancho de la página*/
                            height:100%; /*Toma el 100% del alto de la página*/
                    ...
                    <script type="text/javascript">
                        ...
                        <div style="display:table;width:100%;">
                                        ...
                                        if($atributo['nombre'] != $aux && $c == 0){ ?>
                                            ...
                                            <div style="display:table-cell;height:50px;vertical-align:middle;">
                                                <div style="margin:0 !important;width:100% !important;" class="talla">
                                                    <select id="talla-r" style="width:100%;" name="<?=$atributo['nombre']?>">
                                                        <option value="" selected>Ninguno/a</option>
                            ...
                            <div style="display:table-row;">
                                <div style="display:table-cell;vertical-align:middle;width:76%;">
                                    <span itemprop="price" id="preciopr" style="padding:0 !important;font-size:2em;margin-right: 15px; margin-top: 7px;" class="precio"><?=number_format(ConvertirMoneda($Empresa['moneda'],$_SESSION['divisa'],$producto['precio']), 2, ',', '.')?><?=$producto['precio'] != 'Consultar' ? $_SESSION['moneda'] : ''?></span>
                                </div>
