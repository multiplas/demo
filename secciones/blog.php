...
<div id="contenido" class="container">
	<div class="container">
		<div id="menu-cate"><h3 class="color-menu-cat" style="background-color: <?=$colores['menu']?>; text-align:center;color:<?=$colores['colorgeneralresp']?>;padding-top:5px;padding-bottom:5px;margin:0;margin-top:25px;">Categorías Blog</h3>
			<div style="padding:0px;">
				<ul style="list-style: none;">
					...
					if($menu != null){
						...
						{
							echo '<li><a href="'.$draizp.'/'.$_SESSION[lenguaje].'entradas/'.$menu_in[id].'/'.strtolower(str_replace('--', '-', str_replace(' ', '-', str_replace($no_permitidas, $permitidas , $menu_in[nombre])))).'">'.$menu_in[nombre].'</a></li>';
						}
					}
					?>
				</ul>
					...
					if ($entrada['destacada'] != 1)
					{
						...
						<div class="publicacion">
								...
								?>
												...
												<p style="font-family: <?=$fuente2?>"><?=$descripcion?></p>
