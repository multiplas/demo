...
?>
<div id="contenido">
    <div id="menu-cate"><h3 class="color-menu-cat" style="background-color: <?=$colores['menu']?>; text-align:center;color:white;padding-top:5px;padding-bottom:5px;margin:0;margin-top:25px;">Categorías Blog</h3>
