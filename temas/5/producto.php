            ...
            ?>
                    ...
                    <script type="text/javascript">
                        jQuery(document).ready(function(){
                            var precioUnid = jQuery('#totalspan').text().replace(',','.'); 
                            var importeTotal = precioUnid;                                          
                            ...
                            jQuery('#cantidadmuliselect').change(function(){
                                cantidad = parseFloat(jQuery('#cantidadmuliselect').val());
                                precioUnid = parseFloat(precioUnid);
                                importeTotal = cantidad * precioUnid;
                                importeTotal = importeTotal.toFixed(2)
                                jQuery('#totalspan').attr('data-precio', importeTotal);
                                importeTotal = importeTotal.replace(".",",");
                                jQuery('#totalspan').text(importeTotal);
                            });
                        });
                    </script>
                        ...
                        <div style="display:table; width:100%; border-top: 1px solid rgba(150, 150, 150, 0.3);"><br>
                                <?php
                                    ...
                                    foreach ($atributos AS $atributo){ 
                                        $i++;
                                        $nombreJS = str_replace(" ", "_", preg_replace("[^A-Za-z0-9]", "", $atributo['nombre']));
                                        if($atributo['nombre'] != $aux && $c == 0){ ?>
                                            ...
                                            <div style="display:table-cell;height:50px;vertical-align:middle;">
                                                <div style="margin:0 !important;width:100% !important;" class="talla">
                                                    ...
                                                    ?>
                                                    <option value="<?=$atributo['atributo']?>" <?php if($atributo['defecto'] == 1) echo 'selected' ?>><?=$atributo['atributo']?></option>                                <?php
                                            $aux = $atributo['nombre'];
                                            $c = 1;
                            ...
                            <div style="border-top: 1px solid rgba(150, 150, 150, 0.3);color: #e74e4e;">
                                <div style="display:table-cell;vertical-align:middle;width:100%;">
                                    ...
                                    <?php endif; ?>
                                        <?php if($producto['descuento'] > 0){ ?>
                                            <span class="sale-label" style="position: absolute;"> -<?=$producto['descuento']?>% </span>
                                        <?php } ?>
                                ...
                                <div class="clasetb2" style="vertical-align:middle;width:100%;">
                                    ...
                                    <?php 
                                        ...
                                        {
                                            ?><a href="/contacto" style="cursor: pointer; margin: 25px auto; border-radius: 3px; line-height: 18px; font-weight: normal; padding: 6px; font-size: 16px;" class="button">Consultar precio</a>
                                    <?php
                                        }
                                    ?>   
                                            <script>
