...
<div id="top">
	<div>
		...
		<div>
            ...
            ?>
                <div id="buscador2">
                    <form action="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?><?=$_POST['buscar']?>" method="post">
...
<div id="grupo-contenido">
    <div id="contenido">
        <div>
            <a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>pedido"><img src="<?=$_SESSION['logoURL'] != "" ? $_SESSION['logoURL'] : $draizp.'/source/'.$logoSup?>" alt="" style="max-height: 50px;"></a>
