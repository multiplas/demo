	...
	<div id="piein">
		...
		<div id="lalala">
			<div id="menupie">
				...
				<p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>cuenta"><?=$auxcue?></a></p>
				<p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>cesta"><?=$auxces?></a></p>
                <?php if($_SESSION['usr']['id'] != null){ ?>
				    <p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>compras"><?=$auxped?></a></p>
                <?php } ?>
				<?php
			...
			<div class="enlacespie">
				...
				<?php if($paginasE['20002'] == 1){ ?><p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>devoluciones"><?=$auxenv?></a></p><?php } ?>
				<?php if($paginasE['20001'] == 1){ ?><p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>privacidad"><?=$auxpol?></a></p><?php } ?>
                <?php if($Empresa['desactivarGE'] == 1){ ?><p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>portes"><?=$auxpor?></a></p><?php } ?>
                <?php
                    if(count($paginasP) > 0){
                        foreach($paginasP AS $pag){
                ?>
                            <p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>pagina/<?=$pag['id']?>"><?=$pag['nombre']?></a></p>
                <?php
                        }
                    }
                            }
			...
			<div class="enlacespie">
                ...
                <p><a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?>contacto"><?=$auxcont?></a></p>
