        ...
        ?>
                    ...
                    <script>
                        jQuery(document).ready(function(){
                            ...
                            t1 = t1+30;
                            t2 = t2+30;
                            jQuery('#derecha').css('background','rgba(227, 107, 107, 1) url(<?=$draizp?>/imagenes/<?=$imgizquierda?>) no-repeat scroll right center;');
                            jQuery('#izquierda').css('background','rgba(0, 0, 0, 0) url(<?=$draizp?>/imagenes/<?=$imgderecha?>) no-repeat scroll right center');
