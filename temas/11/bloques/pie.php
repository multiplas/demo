...
<div id="pie" style="text-align: center; background-color: #f4f3ef">
    <img src="<?=$draizp?>/temas/11/img/pie1.jpg" >
    ...
    <div id="linea-roja" style="background-color: #f4f3ef !important">
        <div id="piein">
		
		<div id="lalala" style="width:100%">
			<div id="menupie" style="width:30%">
			...
			<div class="enlacespie" style="width:30%">
			...
			<div class="enlacespie" style="width:30%">
				...
				<p><?=$auxll?> (+34) <?=number_format($Empresa['telefono'], 0, '', ' ')?></p>
                                ...
                                ?>   
                                    <p>
                                        <?=$Empresa['telefono3']?> <img src="/source/whatsapp.png" style="height: 40px;top: 14px; margin-top: -18px; position: relative">
                                    </p>
                                <?php
                                }
                                ?>
    ...
    <img src="<?=$draizp?>/temas/11/img/pie2.jpg" >
    
    <div id="piein">
        <div id="logopie" style="float: left; max-height: 200px !important;"></div>
        <?php include($draiz.'/temas/11/bloques/logos_sociales.php'); ?>
    </div>
</div>
