...
<div id="cabecera" style="z-index: 1000000">
    ...
    ?>
        <span class="nomostrar" style="margin-left: 5px; top: -19px;"><?php
            if($Empresa['wassap'] == 1 && $Empresa['telefono3'] != ''){
            ?>   
                
                    <b>&nbsp;&nbsp;&nbsp;&nbsp;<?=number_format($Empresa['telefono3'], 0, '', ' ')?></b> <img src="<?=$draizp?>/source/whatsapp.png" style="height: 40px;top: 14px;">
        ...
        ?>
            ...
            <span class="posicion"><a class="perfil " title="Mi cuenta" href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/' : ''?>cuenta">&nbsp;</a></span>
            ...
            if(count($cestanum)>0){
            ?>
                    <a href="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/' : ''?>cesta"><span class="boton"><img src="<?=$draizp?>/source/cesta.png"></span> <span class="num-cesta"><?=count($cestanum)?></span></a>
            <?php
                }
        ...
        <div class="" style="float:right; <?=$_SESSION['usr']['nombre'] == '' ? '' : count($divisas) > 2 ? 'margin-top: -35px;' : count($idiomas) > 1 ? 'margin-top: -35px;' : ''?>">Bienvenid@ <?=substr($_SESSION['usr']['nombre'], 0, 36)?>&nbsp;</div><br> 
            <?php } ?>
</div>
