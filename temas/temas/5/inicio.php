                    ...
                    <script>
                        $(document).on("scroll", function(){
                            ...
                            if(desplazamientoActual >= 550){
                                $('#productoMV_0').attr('style', 'visibility: visible');
                                $('#productoMV_0').addClass('animated bounceInRight');
                                $('#productoMV_1').attr('style', 'visibility: visible');
                                $('#productoMV_1').addClass('animated bounceInRight');
                                $('#productoMV_2').attr('style', 'visibility: visible');
                                $('#productoMV_2').addClass('animated bounceInRight');
                                $('#productoMV_3').attr('style', 'visibility: visible');
