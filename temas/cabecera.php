...
<div id="cabecera" style="z-index: 1000000"">
    ...
    <div class='div_datos'>
        ...
        <div class="posicion buscarForm" style="float: left; margin-top: 10px; margin-right: 20px">
            <form action="/es/" method="post">
                <div class="input-group suggest">
                    <input class="" name="buscar" value="" placeholder="Buscar..." type="text">
        ...
        <div id="perfilT" class="" style="float: left; margin-top: -15px; margin-right: 20px">
            
            <nav id="menu_gral">
                  <ul>
                    <li id="prin" style="background-color: transparent;">
                        <a id="perfilc" title="Mi cuenta" href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/cuenta"><img src="<?=$draizp?>/source/perfil3.png"></a>
                    <ul>
                        ...
                        <?php } ?>    
                        <li><a class="stiloli" href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/devoluciones">Envíos y devoluciones</a></li>
                        <li><a class="stiloli" href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/privacidad">Política de privacidad</a></li>
                        <li><a class="stiloli" href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/portes">Gastos de Envío</a></li>    
                    </ul>
                    </li>
                  </ul>
            </nav> 
