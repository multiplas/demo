    ...
    <div class="ruby-menu-demo-header<?=$MM_fondo == 1 ? ' ruby-menu-demo-header-bg' : ''?>">
      ...
      <div class="ruby-wrapper<?=$MM_anchoMax == 1 ? ' ruby-menu-full-width' : ''?>">
        ...
        <ul class="ruby-menu<?=$MM_divisiones == 1 ? ' ruby-menu-dividers' : ''?>">
          ...
          <!-- iconos redes -->
          <?php if($Empresa['lk'] != '' && $Empresa['lk'] != '#'){ ?><li class="ruby-menu-right ruby-menu-social"><a target="_blank" href="<?=$Empresa['lk']?>"><i class="fa fa-linkedin" aria-hidden="true"></i><span>LinkedIn</span></a></li><?php } ?>
          
          <?php if($Empresa['yt'] != '' && $Empresa['yt'] != '#'){ ?><li class="ruby-menu-right ruby-menu-social"><a target="_blank" href="<?=$Empresa['yt']?>"><i class="fa fa-youtube" aria-hidden="true"></i><span>YouTube</span></a></li><?php } ?>
          
          <?php if($Empresa['in'] != '' && $Empresa['in'] != '#'){ ?><li class="ruby-menu-right ruby-menu-social"><a target="_blank" href="<?=$Empresa['in']?>"><i class="fa fa-instagram" aria-hidden="true"></i><span>Instagram</span></a></li><?php } ?>
          
          <?php if($Empresa['pt'] != '' && $Empresa['pt'] != '#'){ ?><li class="ruby-menu-right ruby-menu-social"><a target="_blank" href="<?=$Empresa['pt']?>"><i class="fa fa-pinterest-p" aria-hidden="true"></i><span>Pinterest</span></a></li><?php } ?>
          
          <?php if($Empresa['gp'] != '' && $Empresa['gp'] != '#'){ ?><li class="ruby-menu-right ruby-menu-social"><a target="_blank" href="<?=$Empresa['gp']?>"><i class="fa fa-google-plus" aria-hidden="true"></i><span>Google+</span></a></li><?php } ?>
          
          <?php if($Empresa['tw'] != '' && $Empresa['tw'] != '#'){ ?><li class="ruby-menu-right ruby-menu-social"><a target="_blank" href="<?=$Empresa['tw']?>"><i class="fa fa-twitter" aria-hidden="true"></i><span>Twitter</span></a></li><?php } ?>
          
          <?php if($Empresa['fb'] != '' && $Empresa['fb'] != '#'){ ?><li class="ruby-menu-right ruby-menu-social"><a target="_blank" href="<?=$Empresa['fb']?>"><i class="fa fa-facebook" aria-hidden="true"></i><span>Facebook</span></a></li><?php } ?>

          <!-- Buscador -->
          <li class="ruby-menu-right ruby-menu-social ruby-menu-search ruby-custom-menu-search">
            <form class="animate-input" action="<?=$draizp?>/<?php echo !empty($_SESSION['lenguaje'])?$_SESSION['lenguaje'].'/':'' ?><?=$_POST['buscar']?>" method="post">
                <i class="fa fa-search" aria-hidden="true"></i><input name="buscar" type="text" id="busc" placeholder="Buscar..." value="<?=(isset($_POST['buscar'])) ? $_POST['buscar'] : '';?>" /><span id="BtBuscar" name="BtSubmit"></span>
            </form>
          </li>
